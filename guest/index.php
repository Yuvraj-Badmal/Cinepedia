...
<head>
    ...
    <title>Welcome to Cinepedia</title>
...
<!-- <nav class="navbar navbar-expand-sm bg-secondary navbar-dark fixed-top "> -->
        ...
        <!-- <a class="navbar-brand" href="../index.php">
            <img src="../image/icon.png" alt="logo"> Cinepedia
        </a> -->
            ...
            <center>
                <div class="inner-body ">
                    <h1 class="title ">Welcome to
                        <span style="color: #6AC045 ">Cinepedia</span>
                    </h1>
                    <p style="color: white" class="content">
                        Welcome to
                        <span style="font-weight:bold; color: #fff">Cinepedia</span> | It is site where you can view information about your favourite movie. Cinepedia
                        are best known for the excellent
                        <span style="font-weight:bold; color: #fff">Information</span> for each and every released and not released movies. We are providing this information
                        by the help of
                        <span style="font-weight:bold; color: #fff">MovieDB </span> which known for their movies resources.
                        <span style="font-weight:bold; color: #fff">Browse</span> Movie and get detail aspect of your favourite movie.
                    </p>
                </div>
                <div class="container">
                    <a href="#popup1" class="btn-main btn-main-primary">
