        ...
        <div class="container">
            <div class="" >
                ...
                <div>
                    <center>
                        <div class="content">
                            <h1 style="color: white">Cinepedia: Information about over 10k+ movies</h1>
                            <!-- <p style="color: white">
                                Welcome to
                                <span style="font-weight:bold; color: #6AC045">Cinepedia</span> | It is site where you can view information about your favourite movie.
                                Cinepedia are best known for the excellent
                    ...
                    <form id="searchForm">
                     <center>  <input type="text" class="searchBox" placeholder="Search Movies here" id="searchText"> </center>
                    </form>
                </div>
            </div>
        </div>
